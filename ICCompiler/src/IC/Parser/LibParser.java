...
public class LibParser extends java_cup.runtime.lr_parser
{
	...
	public LibParser(java_cup.runtime.Scanner s)
	{
		super(s);
	}

	/** Constructor which sets the default scanner. */
	public LibParser(java_cup.runtime.Scanner s, java_cup.runtime.SymbolFactory sf)
	{
		super(s, sf);
	}

	/** Production table. */
	protected static final short	_production_table[][]	= unpackFromStrings(new String[] { "\000\024\000\002\003\003\000\002\002\004\000\002\003"
	...
	/** Parse-action table. */
	protected static final short[][]	_action_table	= unpackFromStrings(new String[] { "\000\044\000\004\006\005\001\002\000\006\002\001\006"
	...
	protected static final short[][]	_reduce_table	= unpackFromStrings(new String[] { "\000\044\000\006\003\005\004\003\001\001\000\002\001"
	...
	class CUP$LibParser$actions
	{
		...
		public final java_cup.runtime.Symbol CUP$LibParser$do_action_part00000000(
		    ...
		    java.util.Stack CUP$LibParser$stack, int CUP$LibParser$top)
		    throws java.lang.Exception
		{
			...
			/* . . . . . . . . . . . . . . . . . . . . */
				case 0: // multiLibic ::= libic
				{
					...
					Object lib = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).value;
					...
					CUP$LibParser$result = parser.getSymbolFactory().newSymbol(
					    "multiLibic", 1,
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
				...
				{
					Object RESULT = null;
					int start_valleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).left;
					int start_valright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).right;
					Object start_val = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).value;
					RESULT = start_val;
					CUP$LibParser$result = parser.getSymbolFactory().newSymbol(
					    "$START",
					    0,
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack
					        .elementAt(CUP$LibParser$top - 1)),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
					/* ACCEPT */
				...
				{
					Object RESULT = null;
					int libListleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).left;
					int libListright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).right;
					Object libList = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).value;
					int libleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()).left;
					int libright = ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()).right;
					Object lib = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
				...
				{
					Object RESULT = null;
					int tokleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 5)).left;
					int tokright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 5)).right;
					Object tok = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 5)).value;
					int idleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).left;
					int idright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).right;
					Object id = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).value;
					int lib_method_listleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).left;
					int lib_method_listright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).right;
					Object lib_method_list = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).value;

					RESULT = new ICClass(tokleft, id.toString(), new ArrayList<Field>(),
					    (List<Method>) lib_method_list);

					CUP$LibParser$result = parser.getSymbolFactory().newSymbol(
					    "libic",
					    2,
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack
					        .elementAt(CUP$LibParser$top - 5)),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
					return CUP$LibParser$result;
				...
				case 4: // libic ::= CLASS CLASS_ID LCP multylibmethod RCP
				{
					...
					Object tok = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).value;
					int idleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 3)).left;
					int idright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 3)).right;
					Object id = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 3)).value;
					int lib_method_listleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).left;
					int lib_method_listright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).right;
				...
				{
					Object RESULT = null;
					int method_listleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).left;
					int method_listright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).right;
					Object method_list = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).value;
					int methodleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).left;
					int methodright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).right;
					Object method = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).value;
				...
				{
					Object RESULT = null;
					int typeleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).left;
					int typeright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).right;
					Object type = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).value;
					int idleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 3)).left;
					int idright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					...
					RESULT = new LibraryMethod((Type) type, id.toString(),
					    new ArrayList<Formal>());// (List<Formal>)formal_list);
					...
					/* . . . . . . . . . . . . . . . . . . . . */
				case 8: // libmethod ::= STATIC typeV ID LP libMethodArgumentsList RP
					      // SEMI_COLONS
				{
					Object RESULT = null;
					int typeleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					...
					Object id = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 4)).value;
					int args_listleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).left;
					int args_listright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).right;
					Object args_list = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).value;
					...
					String fg = currentToken.getText();
					RESULT = new LibraryMethod((Type) type, id.toString(),
					    (List<Formal>) args_list);

					CUP$LibParser$result = parser.getSymbolFactory().newSymbol(
					    "libmethod",
					    4,
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack
					        .elementAt(CUP$LibParser$top - 6)),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
					return CUP$LibParser$result;
				...
				case 9: // libMethodArgumentsList ::= libMethodArgument
				{
					...
					Object arg = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).value;
					...
					/* . . . . . . . . . . . . . . . . . . . . */
				case 10: // libMethodArgumentsList ::= libMethodArgument COMMA
					       // libMethodArgumentsList
				{
					Object RESULT = null;
					int argleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).left;
					int argright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).right;
					Object arg = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 2)).value;
					int args_listleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
				...
				{
					Object RESULT = null;
					int tleft = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).left;
					int tright = ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).right;
					Object t = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .elementAt(CUP$LibParser$top - 1)).value;
				...
				case 12: // typeV ::= type
				{
					...
					CUP$LibParser$result = parser.getSymbolFactory().newSymbol("typeV",
					    7, ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
					return CUP$LibParser$result;
				...
				case 13: // typeV ::= VOID
				{
					...
					Object v = (Object) ((java_cup.runtime.Symbol) CUP$LibParser$stack
					    .peek()).value;
				...
				case 14: // type ::= typeNoBrc
				{
					...
					CUP$LibParser$result = parser.getSymbolFactory().newSymbol("type", 9,
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()),
					    ((java_cup.runtime.Symbol) CUP$LibParser$stack.peek()), RESULT);
				}
					return CUP$LibParser$result;
				...
				case 19: // typeNoBrc ::= CLASS_ID
				{
					...
					/* . . . . . . */
				default:
					throw new Exception("Invalid action number " + CUP$LibParser$act_num
		...
		public final java_cup.runtime.Symbol CUP$LibParser$do_action(
		    ...
		    throws java.lang.Exception
		{
			return CUP$LibParser$do_action_part00000000(CUP$LibParser$act_num,
			    CUP$LibParser$parser, CUP$LibParser$stack, CUP$LibParser$top);
		}
	}
