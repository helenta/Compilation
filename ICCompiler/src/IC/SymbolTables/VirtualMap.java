...
public class VirtualMap
{
	...
	public static VirtualMap createExtendsClass(String className,
	    VirtualMap superClass, Scope scope)
	{
		VirtualMap cls = new VirtualMap(className, scope);
		for (String method : superClass.getMethods().keySet())
		{
			cls.addMethod(method, superClass.getMethods().get(method),
			    superClass.getScopeOfMethod(method));
		}
