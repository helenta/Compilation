...
class PolishProgram 
{
    ...
    private HashMap<Integer,Integer> m_MapLines; //Holds mapping from label to line number
    ...
    public void AddError(int errorType, String message)
    {
    	...
    	ErrorTupple currentError = new ErrorTupple(m_CurrentLine+1, errorType, message);
    ...
    public void PrintErrors()
    {
    	...
    	for (int i = 0; i < m_Errors.size(); i++) 
        {
    		...
    		if (tupple.LineNumber != lastLine) {
                System.out.println("Error! Line:" + tupple.LineNumber + " Code:" + tupple.Code);    			
    		}
